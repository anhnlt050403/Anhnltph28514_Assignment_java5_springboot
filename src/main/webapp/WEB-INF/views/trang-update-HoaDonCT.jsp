...
<%--/${dulieuxem.id}--%>
<form:form action="/hoa-don-chi-tiet/update/${dulieuxem.id.hoaDon.id}/${dulieuxem.id.chiTietSP.id}" method="post"
...
<table class="table " style="border: aliceblue 1px">
    ...
    <tr>
        ...
        <th>
            ...
            <form:select path="id.hoaDon" items="${hoaDon}" itemValue="id" itemLabel="ma" id="idhd"
                         disabled="true">
            </form:select>
