...
<table class="table" style="background-color:#00FF00">
    ...
    <c:forEach items="${dulieu}" var="ht" varStatus="stt">
        <tr>
            ...
            <th>${ht.id.gioHang.khachHang.ho} ${ht.id.gioHang.khachHang.tenDem} ${ht.id.gioHang.khachHang.ten} </th>
            <th>${ht.id.chiTietSP.sanPham.ma}-${ht.id.chiTietSP.sanPham.ten} </th>
            ...
            <td>
                   ...
                   <input name="idctsp" value="${ht.id.chiTietSP.id}" style="display: none">
